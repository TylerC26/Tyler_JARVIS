    ...
    >
      <div className="flex items-end gap-2 rounded-sm border border-edge bg-surface-2 px-2 py-1.5 focus-within:border-accent/50">
        ...
        <button
          ...
          className="rounded-sm border border-accent/40 bg-accent/15 px-2.5 py-1 font-mono text-[11px] uppercase tracking-wider text-accent hover:bg-accent/25 disabled:opacity-40 disabled:cursor-not-allowed shrink-0"
        >
          {pending ? "…" : "↵"}
        </button>
      </div>
      <p className="mt-1.5 px-1 font-mono text-[10px] tracking-wider text-fg-dim">
